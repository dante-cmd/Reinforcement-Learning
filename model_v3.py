...
class ClassroomEnv:
    def __init__(self):
        self.classrooms = {
            '101': {'capacity': 15, 'schedule': defaultdict(str)},
            '102': {'capacity': 25, 'schedule': defaultdict(str)},
            '103': {'capacity': 20, 'schedule': defaultdict(str, {
            ...
            '104': {'capacity': 25, 'schedule': defaultdict(str)},
            '105': {'capacity': 20, 'schedule': defaultdict(str, {
        ...
        self.time_slots = ['07:00-08:30', '08:45-10:15', '10:30-12:00']
